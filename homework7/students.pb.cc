...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_students_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::serialization::FullName, surname_),
  PROTOBUF_FIELD_OFFSET(::serialization::FullName, name_),
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::serialization::Student, fullname_),
  PROTOBUF_FIELD_OFFSET(::serialization::Student, grades_),
  PROTOBUF_FIELD_OFFSET(::serialization::Student, averagegrade_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_students_2eproto = {
  false, false, 253, descriptor_table_protodef_students_2eproto, "students.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "serialization.FullName.surname"));
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "serialization.FullName.name"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // string patronymic = 3;
...
class Student::_Internal {
 public:
  static const ::serialization::FullName& fullname(const Student* msg);
};
...
// @@protoc_insertion_point(class_specific_merge_from_start:serialization.Student)
  ...
  if (from.has_fullname()) {
    _internal_mutable_fullname()->::serialization::FullName::MergeFrom(from._internal_fullname());
  }
